    ...
    public partial class mike : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyInfo", x => x.BodyId);
                    table.ForeignKey(
                        name: "FK_BodyInfo_PageCreate_PageCreatepageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FooterId = table.Column<Guid>(nullable: false),
                    PageCreateParentId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FooterInfo", x => x.FooterId);
                    table.ForeignKey(
                        name: "FK_FooterInfo_PageCreate_PageCreatepageId",
                        column: x => x.PageCreatepageId,
                        principalTable: "PageCreate",
                        principalColumn: "pageId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HeaderInfo", x => x.HeaderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodyInfo_PageCreatepageId",
                table: "BodyInfo",
                column: "PageCreatepageId");

            migrationBuilder.CreateIndex(
                name: "IX_FooterInfo_PageCreatepageId",
                table: "FooterInfo",
                column: "PageCreatepageId");
